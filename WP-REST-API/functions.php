...
function setting_add_admin() {
	global $themename;
	add_menu_page($themename, "小程序", 'edit_themes', 'api', 'settings_panel', 'dashicons-awards', 81);
...
include(WP_REST_API_PRO.'/inc/subscription.php');
include(WP_REST_API_PRO.'/inc/random.php');
include(WP_REST_API_PRO.'/inc/adsense.php');
include(WP_REST_API_PRO.'/inc/enadsense.php');
